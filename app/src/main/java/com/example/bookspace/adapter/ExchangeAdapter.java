...
public class ExchangeAdapter extends RecyclerView.Adapter<ExchangeAdapter.ExchangeViewHolder> {
    ...
    public ExchangeAdapter(SharedViewModel viewModel, NavController navController) {
    ...
    @NonNull
    @Override
    public ExchangeAdapter.ExchangeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
